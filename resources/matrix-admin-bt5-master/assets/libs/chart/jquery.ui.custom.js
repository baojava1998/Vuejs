...
(function ($, undefined) {
  ...
  $.ui.plugin.add("draggable", "connectToSortable", {
    ...
    stop: function (event, ui) {
      //If we are still over the sortable, we fake the stop event of the sortable, but also remove helpers
      var inst = $(this).data("draggable"),
        uiSortable = $.extend({}, ui, { item: inst.element });
      ...
      $.each(inst.sortables, function () {
        if (this.instance.isOver) {
          ...
          inst.cancelHelperRemoval = true; //Don't remove the helpers in the draggable instance
          ...
          //If the helpers has been the original item, restore properties in the sortable
          if (inst.options.helper == "original")
            this.instance.currentItem.css({ top: "auto", left: "auto" });
        } else {
          this.instance.cancelHelperRemoval = false; //Remove the helpers in the sortable instance
      ...
      $.each(inst.sortables, function (i) {
        ...
        if (this.instance._intersectsWith(this.instance.containerCache)) {
          ...
          if (!this.instance.isOver) {
            ...
            //We can then fire the start event of the sortable with our passed browser event, and our own helpers (so it doesn't create a new one)
            this.instance.currentItem = $(self)
              .clone()
              .removeAttr("id")
              .appendTo(this.instance.element)
              .data("sortable-item", true);
            this.instance.options._helper = this.instance.options.helper; //Store helpers option to later restore it
          ...
          //we fake the drag stop of the sortable, but make sure it doesn't remove the helpers by using cancelHelperRemoval
          if (this.instance.isOver) {
            this.instance.isOver = 0;
            ...
            //Now we remove our currentItem, the list group clone again, and the placeholder, and animate the helpers back to it's original size
        ...
        o.placeholder = {
          element: function () {
            var el = $(document.createElement(self.currentItem[0].nodeName))
              ...
              .removeClass("ui-sortable-helpers")[0];
      ...
      if (
        (this.fromOutside ||
          this.domPosition.prev !=
            this.currentItem.prev().not(".ui-sortable-helpers")[0] ||
...
(function ($, undefined) {
  ...
  $.widget("ui.button", {
    ...
    destroy: function () {
      this.element.removeClass("ui-helpers-hidden-accessible");
      this.buttonElement
