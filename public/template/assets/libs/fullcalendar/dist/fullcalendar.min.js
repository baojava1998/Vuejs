                ...
                if (
                  !r(t.target).is(
                    i.segSelector +
                      ":not(.fc-helpers)," +
                      i.segSelector +
                      ":not(.fc-helpers) *,.fc-more,a[data-goto]"
                  )
                )
                  return n.call(i, t);
              });
        ...
        m = (function (t) {
          ...
          return (
            ...
            (e.prototype.renderContentSkeleton = function () {
              ...
              for (t = 0; t < this.colCnt; t++)
                n +=
                  '<td><div class="fc-content-col"><div class="fc-event-container fc-helpers-container"></div><div class="fc-event-container"></div><div class="fc-highlight-container"></div><div class="fc-bgevent-container"></div><div class="fc-business-container"></div></div></td>';
              (e = this.contentSkeletonEl =
                ...
                (this.helperContainerEls = e.find(".fc-helpers-container")),
                (this.fgContainerEls = e.find(
                  ".fc-event-container:not(.fc-helpers-container)"
                )),
              ...
              return (
                ...
                this.component.rowEls.each(function (t, o) {
                  var s,
                    a,
                    l = r(o),
                    u = r('<div class="fc-helpers-skeleton"><table/></div>');
                  e && e.row === t
                    ? (a = e.el.position().top)
