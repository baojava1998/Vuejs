    ...
    (this._curInst = null),
      ...
      (this.dpDiv = n(
        t(
          "<div id='" +
            this._mainDivId +
            "' class='ui-datepicker ui-widget ui-widget-content ui-helpers-clearfix ui-corner-all'></div>"
        )
      ));
  }
  function n(e) {
    ...
    t.widget("ui.accordion", {
      ...
      _create: function () {
        ...
        (this.prevShow = this.prevHide = t()),
          this._addClass("ui-accordion", "ui-widget ui-helpers-reset"),
      ...
      _processPanels: function () {
        ...
        (this.headers = this.element.find(this.options.header)),
          ...
          this._addClass(
            ...
            "ui-helpers-reset ui-widget-content"
          ),
    ...
    t.widget("ui.autocomplete", {
      ...
      _create: function () {
        ...
        (this.isMultiLine = o || (!a && this._isContentEditable(this.element))),
          ...
          this._addClass(this.liveRegion, null, "ui-helpers-hidden-accessible"),
    ...
    refresh: function () {
      ...
      this._addClass(
        ...
        "horizontal" === this.options.direction &&
          this._addClass(null, "ui-helpers-clearfix"),
        this._initWidgets(),
        (e = this.childWidgets),
      ...
      t.ui.formResetMixin,
      {
        ...
        _create: function () {
          ...
          this._bindFormResetHandler(),
            ...
            this._addClass("ui-checkboxradio", "ui-helpers-hidden-accessible"),
            this._addClass(
              this.label,
        ...
        dpDiv: i
          ? n(
              t(
                "<div class='" +
                  this._inlineClass +
                  " ui-datepicker ui-widget ui-widget-content ui-helpers-clearfix ui-corner-all'></div>"
              )
            )
          : this.dpDiv,
      };
    ...
    _generateHTML: function (t) {
      ...
      for (
        ...
        for (x = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
          ...
          for (
            T +=
              "<div class='ui-datepicker-header ui-widget-header ui-helpers-clearfix" +
              I +
              "'>" +
      ...
      _createTitlebar: function () {
        ...
        (this.uiDialogTitlebar = t("<div>")),
          this._addClass(
            ...
            "ui-dialog-titlebar",
            "ui-widget-header ui-helpers-clearfix"
          ),
      ...
      _createButtonPane: function () {
        (this.uiDialogButtonPane = t("<div>")),
          this._addClass(
            ...
            "ui-widget-content ui-helpers-clearfix"
          ),
    ...
    t.widget("ui.selectable", t.ui.mouse, {
      ...
      _create: function () {
        ...
        this._addClass("ui-selectable"),
          ...
          this._mouseInit(),
          (this.helper = t("<div>")),
          this._addClass(this.helper, "ui-selectable-helpers");
      },
      _destroy: function () {
      ...
      _mouseStart: function (e, i, s) {
        ...
        return (
          ...
          t.ui.ddmanager &&
            ...
            t.ui.ddmanager.prepareOffsets(this, e),
          (this.dragging = !0),
          this._addClass(this.helper, "ui-sortable-helpers"),
          this._mouseDrag(e),
          !0
        );
      },
          ...
          this._mouseUp(new t.Event("mouseup", { target: null })),
            "original" === this.options.helper
              ? (this.currentItem.css(this._storedCSS),
                this._removeClass(this.currentItem, "ui-sortable-helpers"))
            ...
            element: function () {
              ...
              return (
                e
                  ...
                  ._removeClass(n, "ui-sortable-helpers"),
                "tbody" === s
      ...
      _processTabs: function () {
        ...
        (this.tablist = this._getList().attr("role", "tablist")),
          this._addClass(
            this.tablist,
            "ui-tabs-nav",
            "ui-helpers-reset ui-helpers-clearfix ui-widget-header"
          ),
          this.tablist
